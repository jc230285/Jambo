...
function MapCoords.TestMdist()
	local STORMWIND = ZGV.IsClassic and 1453 or 84 
	local IRONFORGE = ZGV.IsClassic and 1455 or 87 
	local TELDRASSIL = ZGV.IsClassic and 1446 or 57 

	local tests = ZGV.IsClassic and {
		"same map",
