...
ItemScore.rules = {
	...
	["HUNTER"] = { -- cloth/leather only till 40, mail from 40
		[1] = { 
			...
			stats = {STRENGTH=0.05, AGILITY=1, DAMAGE_PER_SECOND=2.4, ATTACK_POWER=0.43, RANGED_ATTACK_POWER=0.43, HIT=1, EXPERTISE=0.05, CRIT=0.8, HASTE=0.5, ARMOR_PENETRATION=0.17, INTELLECT=0.8, MANA=0.075, SPIRIT=1, MANA_REGENERATION=2.4, STAMINA=0.5, HEALTH=0.02, HEALTH_REGENERATION=1, ARMOR=0.005, DEFENSE_SKILL=0.05, DODGE=0.05, PARRY=0.05, FIRE_RESISTANCE=0.04, FROST_RESISTANCE=0.04, ARCANE_RESISTANCE=0.04, SHADOW_RESISTANCE=0.04, NATURE_RESISTANCE=0.04},
			caps = { HIT=5, },
		},
		[2] = { 
			name="Marksmanship", 
			itemtypes = { CLOTH=-40, LEATHER=-40, MAIL=40, BOW=1, CROSSBOW=1, GUN=1, TH_SWORD=1, TH_AXE=1, SWORD=1, AXE=1, FIST=1, TH_POLE=1, DAGGER=1, TH_STAFF=1, THROWN=1 },
			stats = {STRENGTH=0.05, AGILITY=1, DAMAGE_PER_SECOND=2.6, ATTACK_POWER=0.55, RANGED_ATTACK_POWER=0.55, HIT=1, EXPERTISE=0.05, CRIT=0.6, HASTE=0.4, ARMOR_PENETRATION=0.37,INTELLECT=0.9, MANA=0.085, SPIRIT=1, MANA_REGENERATION=2.4, STAMINA=0.5, HEALTH=0.05, HEALTH_REGENERATION=1, ARMOR=0.005, DEFENSE_SKILL=0.05, DODGE=0.05, PARRY=0.05, FIRE_RESISTANCE=0.04, FROST_RESISTANCE=0.04, ARCANE_RESISTANCE=0.04, SHADOW_RESISTANCE=0.04, NATURE_RESISTANCE=0.04},
			caps = { HIT=5, },
		},
		[3] = { 
			name="Survival", 
		...
		[4] = { 
			name="Melee Hunter", 
			itemtypes = { CLOTH=-40, LEATHER=-40, MAIL=40, BOW=1, CROSSBOW=1, GUN=1, TH_SWORD=1, TH_AXE=1, SWORD=1, AXE=1, FIST=1, TH_POLE=1, DAGGER=1, TH_STAFF=1, THROWN=1 },
			stats = {STRENGTH=.7, AGILITY=1, DAMAGE_PER_SECOND=2.4, ATTACK_POWER=0.55, RaNGED_ATTACK_POWER=0.01, HIT=1, EXPERTISE=0.05, CRIT=0.65, HASTE=0.4, ARMOR_PENETRATION=0.28,INTELLECT=0.05, MANA=0.005, SPIRIT=0.1, MANA_REGENERATION=0.01, STAMINA=0.5, HEALTH=0.05, HEALTH_REGENERATION=1, ARMOR=0.005, DEFENSE_SKILL=0.05, DODGE=0.05, PARRY=0.05, FIRE_RESISTANCE=0.04, FROST_RESISTANCE=0.04, ARCANE_RESISTANCE=0.04, SHADOW_RESISTANCE=0.04, NATURE_RESISTANCE=0.04},
			caps = { HIT=6, },
		},
	},
	["MAGE"] = {
		[1] = { 
			...
			stats = {AGILITY=0.05, INTELLECT=0.96, MANA=0.038, SPIRIT=0.59, MANA_REGENERATION=1.13, SPELL_DAMAGE_DONE=1, SPELL_DAMAGE_DONE_FIRE=0.064, SPELL_DAMAGE_DONE_FROST=0.52, SPELL_DAMAGE_DONE_ARCANE=0.88, HIT_SPELL=0.87, CRIT_SPELL=0.6, HASTE=0.59, SPELL_PENETRATION=0.09,STAMINA=0.5, HEALTH=0.05, HEALTH_REGENERATION=1, ARMOR=0.005, DEFENSE_SKILL=0.05, DODGE=0.05, PARRY=0.05, FIRE_RESISTANCE=0.04, FROST_RESISTANCE=0.04, ARCANE_RESISTANCE=0.04, SHADOW_RESISTANCE=0.04, NATURE_RESISTANCE=0.04},
			caps = { HIT_SPELL=4, },
		},
		[2] = { 
			name="Fire", 
			itemtypes = {CLOTH=1, TH_STAFF=1, DAGGER=1, SWORD=1, WAND=1,  },
			stats = {SPELL_PENETRATION = 0.340, MANA_REGENERATION = 0.333, SPELL_DAMAGE_DONE = 0.158, SPELL_DAMAGE_DONE_FIRE = 0.158, HIT_SPELL = 1.07, HIT = 1.07, INTELLECT = 0.9, CRIT_SPELL = 0.74, SPIRIT = 0.055, SPELL_DAMAGE_DONE_FROST = 0.041, SPELL_DAMAGE_DONE_ARCANE = 0.041, DAMAGE_PER_SECOND = 0.012},
			caps = { HIT_SPELL=4, },
		},
		[3] = { 
			name="Frost", 
			itemtypes = {CLOTH=1, TH_STAFF=1, DAGGER=1, SWORD=1, WAND=1,  },
			stats = {AGILITY=0.05, INTELLECT=0.87, MANA=0.032, SPIRIT=0.06, MANA_REGENERATION=0.8, SPELL_DAMAGE_DONE=1, SPELL_DAMAGE_DONE_FIRE=0.05, SPELL_DAMAGE_DONE_FROST=0.95, SPELL_DAMAGE_DONE_ARCANE=0.13, HIT_SPELL=1.22, CRIT_SPELL=0.58, HASTE=0.63, SPELL_PENETRATION=0.07,STAMINA=0.5, HEALTH=0.05, HEALTH_REGENERATION=1, ARMOR=0.005, DEFENSE_SKILL=0.05, DODGE=0.05, PARRY=0.05, FIRE_RESISTANCE=0.04, FROST_RESISTANCE=0.04, ARCANE_RESISTANCE=0.04, SHADOW_RESISTANCE=0.04, NATURE_RESISTANCE=0.04},
			caps = { HIT_SPELL=4, },
		},
		[4] = { 
			name="Arcane Healing", 
			itemtypes = {CLOTH=1, TH_STAFF=1, DAGGER=1, SWORD=1, WAND=1,  },
			stats = {AGILITY=0.05, INTELLECT=1, MANA=0.038, SPIRIT=0.29, MANA_REGENERATION=1.13, SPELL_DAMAGE_DONE=.9, SPELL_DAMAGE_DONE_FIRE=0.004, SPELL_DAMAGE_DONE_FROST=0.02, SPELL_DAMAGE_DONE_ARCANE=0.9, HIT_SPELL=1, CRIT_SPELL=0.6, HASTE=0.59, SPELL_PENETRATION=0.09,STAMINA=0.5, HEALTH=0.05, HEALTH_REGENERATION=1, ARMOR=0.005, DEFENSE_SKILL=0.05, DODGE=0.05, PARRY=0.05, FIRE_RESISTANCE=0.04, FROST_RESISTANCE=0.04, ARCANE_RESISTANCE=0.04, SHADOW_RESISTANCE=0.04, NATURE_RESISTANCE=0.04},
			caps = { HIT_SPELL=4, },
		}
	},
	...
	["PRIEST"] = {
		[1] = {
			...
			stats = {AGILITY=0.05, INTELLECT=1, MANA=0.09, SPIRIT=0.78, MANA_REGENERATION=1.19, SPELL_HEALING_DONE=0.72, CRIT_SPELL=0.32, HASTE=0.57, STAMINA=0.5, HEALTH=0.05, HEALTH_REGENERATION=1, ARMOR=0.005, DEFENSE_SKILL=0.05, DODGE=0.05, PARRY=0.05, FIRE_RESISTANCE=0.04, FROST_RESISTANCE=0.04, ARCANE_RESISTANCE=0.04, SHADOW_RESISTANCE=0.04, NATURE_RESISTANCE=0.04},
			caps = { HIT_SPELL=4, },
		},
		[2] = {
			name="Holy", 
	...
	["ROGUE"] = {
		...
		[4] = { 
			name="Combat Tank", 
			itemtypes = { CLOTH=1, LEATHER=1, BOW=1, CROSSBOW=1, DAGGER=1, FIST=1, GUN=1, MACE=1, SWORD=1, THROWN=1, },
			stats = {STRENGTH=0.1, AGILITY=1, DAMAGE_PER_SECOND=3, ATTACK_POWER=0.45, HIT=.5, EXPERTISE=1.1, CRIT=0.21, HASTE=0.9, ARMOR_PENETRATION=0.24, SPIRIT=0.05, MANA_REGENERATION=0, STAMINA=0.8, HEALTH=0.05, HEALTH_REGENERATION=1, ARMOR=0.005, DEFENSE_SKILL=0.05, DODGE=0.75, PARRY=0.62, FIRE_RESISTANCE=0.04, FROST_RESISTANCE=0.04, ARCANE_RESISTANCE=0.04, SHADOW_RESISTANCE=0.04, NATURE_RESISTANCE=0.04},
			caps = { HIT=24, },
		}
	},
	["SHAMAN"] = { -- cloth/leather only till 40, mail from 40
		...
		[2] = { 
			name="Enhancement",
			itemtypes = { CLOTH=-40, LEATHER=-40, MAIL=40, SHIELD=1, AXE=1, TH_AXE=1, DAGGER=1, FIST=1, MACE=1, TH_MACE=1, TH_STAFF=1, },
			stats = {STRENGTH=1, AGILITY=0.87, DAMAGE_PER_SECOND=3, ATTACK_POWER=0.5, HIT=0.67, EXPERTISE=1.5, CRIT=0.98, HASTE=0.64, ARMOR_PENETRATION=0.12,INTELLECT=0.34, MANA=0.032, SPIRIT=0.05, MANA_REGENERATION=1, SPELL_DAMAGE_DONE=0.3, SPELL_DAMAGE_DONE_NATURE=0.3, HIT_SPELL=0.223, CRIT_SPELL=0.326, HASTE=0.08, SPELL_PENETRATION=0.11,STAMINA=0.65, HEALTH=0.05, HEALTH_REGENERATION=1, ARMOR=0.005, DEFENSE_SKILL=0.05, DODGE=0.05, PARRY=0.05, FIRE_RESISTANCE=0.04, FROST_RESISTANCE=0.04, ARCANE_RESISTANCE=0.04, SHADOW_RESISTANCE=0.04, NATURE_RESISTANCE=0.04},
			caps = { HIT=24, },
		},
		[3] = {
			name="Restoration", 
	...
	["WARLOCK"] = {
		[1] = {
			...
			stats = {AGILITY=0.05, INTELLECT=1, MANA=0.03, SPIRIT=0.1, MANA_REGENERATION=1, SPELL_DAMAGE_DONE=1, SPELL_DAMAGE_DONE_FIRE=0.35, SPELL_DAMAGE_DONE_SHADOW=0.91, HIT_SPELL=1.2, CRIT_SPELL=0.39, HASTE=0.78, SPELL_PENETRATION=0.08,STAMINA=0.5, HEALTH=0.05, HEALTH_REGENERATION=1, ARMOR=0.005, DEFENSE_SKILL=0.05, DODGE=0.05, PARRY=0.05, FIRE_RESISTANCE=0.04, FROST_RESISTANCE=0.04, ARCANE_RESISTANCE=0.04, SHADOW_RESISTANCE=0.04, NATURE_RESISTANCE=0.04},
			caps = { HIT_SPELL=4, },
		},
		[2] = {
			name="Demonology", 
			itemtypes = { CLOTH=1, DAGGER=1, WAND=1, TH_STAFF=1, SWORD=1, },
			stats = {AGILITY=0.05, INTELLECT=1, MANA=0.03, SPIRIT=0.3, MANA_REGENERATION=1, SPELL_DAMAGE_DONE=1, SPELL_DAMAGE_DONE_FIRE=0.80, SPELL_DAMAGE_DONE_SHADOW=0.8, HIT_SPELL=1.2, CRIT_SPELL=0.66, HASTE=0.7, SPELL_PENETRATION=0.08,STAMINA=0.5, HEALTH=0.05, HEALTH_REGENERATION=1, ARMOR=0.005, DEFENSE_SKILL=0.05, DODGE=0.05, PARRY=0.05, FIRE_RESISTANCE=0.04, FROST_RESISTANCE=0.04, ARCANE_RESISTANCE=0.04, SHADOW_RESISTANCE=0.04, NATURE_RESISTANCE=0.04},
			caps = { HIT_SPELL=4, },
		},
		[3] = {
			name="Destruction", 
			itemtypes = { CLOTH=1, DAGGER=1, WAND=1, TH_STAFF=1, SWORD=1, },
			stats = {AGILITY=0.05, INTELLECT=1, MANA=0.028, SPIRIT=0.25, MANA_REGENERATION=0.65, SPELL_DAMAGE_DONE=1, SPELL_DAMAGE_DONE_FIRE=0.23, SPELL_DAMAGE_DONE_SHADOW=0.95, HIT_SPELL=1.6, CRIT_SPELL=0.87, HASTE=1.15, SPELL_PENETRATION=0.08,STAMINA=0.5, HEALTH=0.05, HEALTH_REGENERATION=1, ARMOR=0.005, DEFENSE_SKILL=0.05, DODGE=0.05, PARRY=0.05, FIRE_RESISTANCE=0.04, FROST_RESISTANCE=0.04, ARCANE_RESISTANCE=0.04, SHADOW_RESISTANCE=0.04, NATURE_RESISTANCE=0.04},
			caps = { HIT_SPELL=4, },
		},
		[4] = {
			name="Warlock Tank", 
			itemtypes = { CLOTH=1, DAGGER=1, WAND=1, TH_STAFF=1, SWORD=1, },
			stats = {AGILITY=0.05, INTELLECT=0.5, MANA=0.03, SPIRIT=0.3, MANA_REGENERATION=1, SPELL_DAMAGE_DONE=1, SPELL_DAMAGE_DONE_FIRE=0.80, SPELL_DAMAGE_DONE_SHADOW=0.8, HIT_SPELL=1.2, CRIT_SPELL=0.66, HASTE=0.7, SPELL_PENETRATION=0.08,STAMINA=1, HEALTH=0.05, HEALTH_REGENERATION=1, ARMOR=0.015, DEFENSE_SKILL=0.05, DODGE=0.05, PARRY=0.05, FIRE_RESISTANCE=0.04, FROST_RESISTANCE=0.04, ARCANE_RESISTANCE=0.04, SHADOW_RESISTANCE=0.04, NATURE_RESISTANCE=0.04},
			caps = { HIT_SPELL=4, },
		}
	},
	["WARRIOR"] = { -- cloth/leather,mail only till 40, plate from 40
		...
		[4] = {
			name="FuryProt", 
			itemtypes = {CLOTH=-40, LEATHER=-40, MAIL=-40, PLATE=40, SHIELD=1, AXE=1, TH_AXE=1, BOW=1, CROSSBOW=1, DAGGER=1, FIST=1, GUN=1, MACE=1, TH_MACE=1, TH_POLE=1, TH_STAFF=1, SWORD=1, TH_SWORD=1, OFFHAND=1, MISCARM=1, THROWN=1,  },
			stats = {STRENGTH=0.33, AGILITY=0.69, DAMAGE_PER_SECOND=3.13, ATTACK_POWER=0.06, HIT=0.97, EXPERTISE=0.67, CRIT=0.58, HASTE=0.21, ARMOR_PENETRATION=0.19, SPIRIT=0.05, MANA_REGENERATION=0, STAMINA=1, HEALTH=0.09, HEALTH_REGENERATION=2, ARMOR=0.02, DEFENSE_SKILL=0.81, DODGE=0.7, PARRY=0.58, BLOCK=0.59, BLOCK_VALUE=0.35, FIRE_RESISTANCE=0.2, FROST_RESISTANCE=0.2, ARCANE_RESISTANCE=0.2, SHADOW_RESISTANCE=0.2, NATURE_RESISTANCE=0.2},
			caps = { HIT=5, },
		}
	},
}